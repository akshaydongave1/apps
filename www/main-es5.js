...
var routes = [
    ...
    {
        path: 'customer',
        loadChildren: function () { return __webpack_require__.e(/*! import() | customer-customer-module */ "customer-customer-module").then(__webpack_require__.bind(null, /*! ./customer/customer.module */ "./src/app/customer/customer.module.ts")).then(function (m) { return m.CustomerPageModule; }); }
    },
    {
        path: 'add-new-customer',
        loadChildren: function () { return Promise.all(/*! import() | add-new-customer-add-new-customer-module */[__webpack_require__.e("common"), __webpack_require__.e("add-new-customer-add-new-customer-module")]).then(__webpack_require__.bind(null, /*! ./add-new-customer/add-new-customer.module */ "./src/app/add-new-customer/add-new-customer.module.ts")).then(function (m) { return m.AddNewCustomerPageModule; }); }
    }
];
...
module.exports = __webpack_require__(/*! /home/akshay/workspace/practice/Dairy/src/main.ts */"./src/main.ts");
