...
var CustomerPage = /** @class */ (function () {
    function CustomerPage(formBuilder, http, alertController, navCtrl) {
    ...
    CustomerPage.prototype.goToAddCustomer = function () {
        this.navCtrl.navigateForward("add-new-customer");
    };
    CustomerPage.prototype.presentAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var str, alert, mob, elementWrap, elementInnerGroup, elementBtn, CustForm, CustNameElm;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        str = '<div class="doCenterData">  <form id="cform"> <span>Customer Name</span>' +
                    ...
                    case 1:
                        ...
                        elementWrap = document.getElementsByClassName("alert-wrapper")[0];
                        elementWrap.style.borderRadius = "20px";
                        elementWrap.style.width = "90%";
                        elementInnerGroup = document.getElementsByClassName("alert-message")[0];
                        ...
                        elementBtn = document.getElementsByClassName("alert-button-group")[0];
                        ...
                        CustForm = document.getElementById('cform');
                        CustForm.setAttribute("formGroup", "CustName");
                        CustNameElm = document.getElementById('cname');
